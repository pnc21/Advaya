...
const geminiApiKey = 'AIzaSyD1DU0VCV726372i8wfp0p6pAcwLP4JiZc'
  ...
  return (
    <div className="flex flex-wrap gap-[26px]">
      <button
        ...
        className="mt-6 inline-flex items-center gap-x-2 rounded-full border border-neutral-700   bg-[#13131a] px-4 py-2 text-sm font-medium text-white  shadow-sm hover:bg-neutral-800  disabled:pointer-events-none disabled:opacity-50 dark:border-gray-200 dark:bg-white dark:text-gray-800 dark:hover:bg-gray-50"
      >
        <IconFileUpload />
        Upload Reports
      </button>
        ...
        <div className="flex flex-col">
          <div className="-m-1.5 overflow-x-auto">
            <div className="inline-block min-w-full p-1.5 align-middle">
              <div className="overflow-hidden rounded-xl border border-neutral-700  bg-[#13131a]  shadow-sm dark:border-gray-200 dark:bg-white">
                ...
                <div className="flex w-full flex-col px-6 py-4 text-white">
                  ...
                  <div className="mt-5 grid gap-2 sm:flex">
                    <button
                      ...
                      className="inline-flex items-center gap-x-2 rounded-lg border border-neutral-700 bg-neutral-900  px-3 py-2 text-sm font-medium text-white  shadow-sm hover:bg-neutral-800  disabled:pointer-events-none disabled:opacity-50 dark:border-gray-200 dark:bg-white dark:text-gray-800 dark:hover:bg-gray-50"
                    >
                      View Treatment plan
                ...
                <div className="grid gap-3 border-t border-neutral-700  px-6 py-4 md:flex md:items-center md:justify-between dark:border-gray-200">
                  <div>
                    <p className="text-sm text-gray-600 dark:text-neutral-400">
                      <span className="font-semibold text-neutral-200  dark:text-gray-800"></span>{" "}
                    </p>
                  </div>
                  <div>
